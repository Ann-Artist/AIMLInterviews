...
- LinkedIn
  ...
  - 深入了解 LinkedIn Learning 课程推荐背后的 AI，[Part 1](https://engineering.linkedin.com/blog/2020/course-recommendations-ai-part-one)，[Part 2](https://engineering.linkedin.com/blog/2020/course-recommendations-ai-part-two)
...
- Google
  ...
  - 使用 TFX 和 KubeFlow 的机器学习流水线
  - [Google 搜索如何工作](https://www.google.com/search/howsearchworks/)
    - Page Rank 算法（[intro to page rank](https://www.youtube.com/watch?v=IKXvSKaI2Ko)，[the algorithm that started google](https://www.youtube.com/watch?v=qxEkY8OScYY)）
  - [Robert Crowe 的 TFX workshop](https://conferences.oreilly.com/artificial-intelligence/ai-ca-2019/cdn.oreillystatic.com/en/assets/1/event/298/TFX_%20Production%20ML%20pipelines%20with%20TensorFlow%20Presentation.pdf)
